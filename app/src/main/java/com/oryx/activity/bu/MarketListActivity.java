...
public class MarketListActivity extends AbstractActivity {
    ...
    public void scanBar(View v) {
        try {
            ...
            showDialog(MarketListActivity.this, "No Scanner Found", "Download a scanner code activity?", "Yes", "No").show();
        }
    }

    public void addProduct(View v) {
        if (!_codeField.getText().toString().isEmpty()) {
            final ProgressDialog progressDialog = new ProgressDialog(MarketListActivity.this,
