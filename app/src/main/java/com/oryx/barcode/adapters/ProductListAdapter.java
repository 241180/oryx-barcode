package com.oryx.barcode.adapters;
...
public class ProductListAdapter extends ArrayAdapter<String> {
    ...
    public ProductListAdapter(Context context, String[] values) {
        super(context, R.layout.activity_list_product, values);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.activity_list_product, parent, false);
