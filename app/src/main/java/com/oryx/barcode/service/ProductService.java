...
public class ProductService{
    public static GsonResponse<ProductVO> findByCodeAndFormat(String host, String code, String format, final TextView descriptionField) {
        ...
        JsonHttpResponseHandlerExt<GsonResponse<ProductVO>> jsonHttpResponseHandlerExt = new JsonHttpResponseHandlerExt(GsonResponse.class);
        HttpHelper.post(targetUrl, rp, jsonHttpResponseHandlerExt);

        return jsonHttpResponseHandlerExt.getObject();
    }

    public static GsonResponse<ProductVO> create(String host, String format, ProductVO productVO) {
        Gson gson = new Gson();
    ...
    public static GsonResponse<ProductVO> delete(String host, String format, String xcode) {
        RequestParams rp = new RequestParams();
        rp.add("xformat", format);
        rp.add("xcode", xcode);
